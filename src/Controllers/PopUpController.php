...
class PopUpController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('werknhub::back.popups.index', compact('popups'));
    }

    public function create()
    {
        return view('werknhub::back.popups.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('werknhub::back.popups.show')->with('popup', $popup);
    }
    ...
    {
        $popup = Popup::find($id);
        return view('werknhub::back.popups.edit', compact('popup'));
    }
