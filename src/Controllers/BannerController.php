...
class BannerController extends Controller
{
    public function index()
    {
        ...
        return view('werknhub::back.banners.index', compact('banners'));
    }

    public function create()
    {
        return view('werknhub::back.banners.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('werknhub::back.banners.show')->with('banner', $banner);
    }
    ...
    {
        $banner = Banner::find($id);
        return view('werknhub::back.banners.edit', compact('banner'));
    }
