...
use Nowyouwerkn\WerknHub\Models\Headerband;
...
class HeaderbandController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('werknhub::back.headerbands.index', compact('headerbands'));
    }

    public function create()
    {
        return view('werknhub::back.headerbands.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('werknhub::back.headerbands.show')->with('headerband', $headerband);
    }
    ...
    public function edit($id)
    {
        ...
        return view('werknhub::back.headerbands.edit', compact('headerband'));
    }
