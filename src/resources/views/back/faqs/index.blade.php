        ...
        @else
            ...
            <form method="POST" action="{{ route('faq.update', $faqs->id) }}" enctype="multipart/form-data">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <h4 class="mb-3">
                        <input type="text" name="title" value="{{ $faqs->title }}" required="" />
                        </h4>
                        ...
                        <textarea id="justHtml_{{ $faqs->id }}" name="description" required="" style="display:none;">{!! $faqs->description ?? '' !!}</textarea>
